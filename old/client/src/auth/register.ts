...
if (form_register) {
  form_register.addEventListener("submit", async (event) => {
    ...
    const passwordRepeat = (<HTMLFormElement>document.getElementById("passwordRepeat")).value
    const username = (<HTMLFormElement>document.getElementById("username")).value
